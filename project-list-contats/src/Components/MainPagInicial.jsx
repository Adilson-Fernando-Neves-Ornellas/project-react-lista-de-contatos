...
const MainPagInicial = () => {
  ...
  // Função para traduzir o valor booleano em português
  ...
  return (
    <>
      <div className="container">
        <form className="formCadastro" onSubmit={adicionar}>
            ...
            {contatos.map((item) => (
              <li className="liContatos">
                ...
                <div className="ConteinerButtonsLi">
                  <button className="buttonsLi" onClick={editar}>EDITAR</button>
                  <button className="buttonsLi" onClick={deletar}>DELETAR</button>
                </div>
                <hr/>
              </li>
            ))}
